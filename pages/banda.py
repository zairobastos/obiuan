...
with col1:
    ...
    st.markdown("&emsp; • Em um conjunto de casos de teste que totaliza 80 pontos, N ≤ 50 e M ≤ 2450.")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Banda"
            dados.rota_questao = "banda"
