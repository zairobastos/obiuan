...
with col1:
    ...
    st.text("Uma fita esticada horizontalmente é composta de N quadrados de dimensão 1 x 1, cada um deles contendo um número inteiro anotado. Temos também K etiquetas retangulares idênticas, de dimensão 1 x C, onde C é um inteiro. Nosso objetivo é colar todas as etiquetas sobre a fita de modo que a soma dos inteiros que não estiverem cobertos por nenhuma etiqueta ao final seja a máxima possível. Cada etiqueta deve ser colada na horizontal, ao longo da fita. Duas etiquetas não podem estar sobrepostas e cada quadrado da fita deve estar ou totalmente coberto por uma etiqueta, ou totalmente descoberto.")

    st.subheader("Entrada")
    st.text("A primeira linha da entrada contém três inteiros N, K e C, representando, respectivamente, o comprimento da fita, o número de etiquetas e o comprimento das etiquetas. A segunda linha da entrada contém N inteiros A indicando a sequência de números anotados nos quadrados da fita.")

    st.subheader("Saída")
    st.text("Seu programa deve imprimir uma linha contendo um inteiro indicando a soma máxima possível de inteiros descobertos na fita depois que todas as etiquetas sejam coladas seguindo as condições do enunciado.")

    st.subheader("Restrições")
    st.markdown("&emsp; • 1 ≤ N ≤ 10000")
    st.markdown("&emsp; • -10000 ≤ A ≤ 10000")
    st.markdown("&emsp; • 1 ≤ K ≤ 10000")
    st.markdown("&emsp; • 1 ≤ C ≤ 10000")
    st.markdown("""&emsp; • K\times C ≤ N""")

    st.subheader("Informações sobre a pontuação")
    st.markdown("&emsp; • Para um conjunto de casos de testes valendo 10 pontos, os números no vetor estão ordenados crescentemente.")
    st.markdown("&emsp; • Para um conjunto de casos de testes valendo outros 10 pontos, C=1.")
    st.markdown("&emsp; • Para um conjunto de casos de testes valendo outros 20 pontos, K=1.")
    st.markdown("&emsp; • Para um conjunto de casos de testes valendo outros 20 pontos, K,N ≤ 100.")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Etiquetas"
            dados.rota_questao = "etiquetas"
