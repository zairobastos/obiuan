...
with col1:
    ...
    with col22:
        st.header("Metrô da Nlogônia")

    st.markdown("[Metrô da Nlogônia](https://olimpiada.ic.unicamp.br/pratique/p2/2019/f3/metro/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Metrô da Nlogônia"
            dados.rota_questao = "metro_da_nlogonia"
