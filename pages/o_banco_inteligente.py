...
with col1:
    ...
    with col22:
        st.header("O Banco Inteligente")

    st.markdown("[O Banco Inteligente](https://olimpiada.ic.unicamp.br/pratique/p2/2015/f1/banco/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "O Banco Inteligente"
            dados.rota_questao = "o_banco_inteligente"
