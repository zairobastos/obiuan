...
with col1:
    ...
    with col22:
        st.header("Dona Formiga")

    st.markdown("[Dona Formiga](https://olimpiada.ic.unicamp.br/pratique/p2/2020/f2/formiga/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Dona Formiga"
            dados.rota_questao = "dona_formiga"
