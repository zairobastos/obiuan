...
with col1:
    ...
    with col24:
        st.image("./images/quadrado.png",width=100)

    st.subheader("Entrada")
    st.text("A primeira linha da entrada contém um único número inteiro N, indicando a ordem do quadrado (seu número de linhas). As N linhas seguintes descrevem o quadrado. Cada uma dessas linhas contém N números inteiros separados por um espaço em branco.")

    st.subheader("Saída")
    st.text("Seu programa deve imprimir uma única linha na saída padrão. Caso o quadrado seja mágico, a linha deve conter o valor do quadrado (ou seja, a soma de uma de suas linhas). Caso contrário, a linha deve conter o número 0.")

    st.subheader("Restrições")
    st.markdown("&emsp; • 3 ≤ N ≤ 1000")
    st.markdown("&emsp; • 2 ≤ valor de cada célula ≤ 10⁹")
