...
with col1:
    ...
    with col22:
        st.header("Jogo de Cartas")

    st.markdown("[Jogo de Cartas](https://olimpiada.ic.unicamp.br/pratique/p2/2006/f1/cartas/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Jogo de Cartas"
            dados.rota_questao = "jogo_de_cartas"
