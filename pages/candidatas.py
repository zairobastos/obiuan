...
with col1:
    ...
    with col22:
        st.header("Candidatas")

    st.markdown("[Candidatas](https://olimpiada.ic.unicamp.br/pratique/p2/2020/f3/candidatas/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Candidatas"
            dados.rota_questao = "candidatas"
