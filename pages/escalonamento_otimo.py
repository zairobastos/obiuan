...
with col1:
    ...
    with col22:
        st.header("Escalonamento ótimo")

    st.markdown("[Escalonamento ótimo](https://olimpiada.ic.unicamp.br/pratique/p2/2011/f2/escalona/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Escalonamento ótimo"
            dados.rota_questao = "escalonamento_otimo"
