...
with col1:
    ...
    with col22:
        st.header("Dario e Xerxes")

    st.markdown("[Dario e Xerxes](https://olimpiada.ic.unicamp.br/pratique/p2/2017/f2/xerxes/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Dario e Xerxes"
            dados.rota_questao = "dario_e_xerxes"
