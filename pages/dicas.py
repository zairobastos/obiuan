...
def return_dica(rota_dica):
    with open(dados.dica[rota_dica], "r", encoding="utf-8") as arquivo:
...
with col1:
    ...
    st.subheader("Dicas geradas para você")

    st.info(return_dica(dados.rota_questao))

    #st.text("Agora, com as dicas, faça os ajustes na sua resposta e tente novamente, dependendo da porcentagem de acerto da questão posso lhe ajudar ainda mais precisamente.")
