...
with col1:
    ...
    with col22:
        st.header("Lanche na empresa")

    st.markdown("[Lanche na empresa](https://olimpiada.ic.unicamp.br/pratique/p2/2008/f1/lanche/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Lanche na empresa"
            dados.rota_questao = "lanche_na_empresa"
