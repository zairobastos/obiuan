...
with col1:
    ...
    with col22:
        st.header("Câmara de Compensação")

    st.markdown("[Câmara de Compensação](https://olimpiada.ic.unicamp.br/pratique/p2/2018/f1/compensacao/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Câmara de Compensação"
            dados.rota_questao = "camara_de_compensacao"
