...
with col1:
    ...
    with col22:
        st.header("Dona Minhoca")

    st.markdown("[Dona Minhoca](https://olimpiada.ic.unicamp.br/pratique/p2/2021/f3/minhoca/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Dona Minhoca"
            dados.rota_questao = "dona_minhoca"
