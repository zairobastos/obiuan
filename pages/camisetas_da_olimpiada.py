...
with col1:
    ...
    with col22:
        st.header("Camisetas da Olimpíada")

    st.markdown("[Camisetas da Olimpíada](https://olimpiada.ic.unicamp.br/pratique/p2/2020/f1/camisetas/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Camisetas da Olimpíada"
            dados.rota_questao = "camisetas_da_olimpiada"
