...
with col1:
    ...
    with col22:
        st.header("Escada perfeita")

    st.markdown("[Escada perfeita](https://olimpiada.ic.unicamp.br/pratique/p2/2006/f1/escada/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Escada perfeita"
            dados.rota_questao = "escada_perfeita"
