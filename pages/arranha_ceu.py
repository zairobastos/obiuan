...
with col1:
    ...
    with col22:
        st.header("Arranha-céu")

    st.markdown("[Arranha-céu](https://olimpiada.ic.unicamp.br/pratique/p2/2017/f3/arranhaceu/)")

    st.subheader("Sua resposta")
    st.markdown("A resposta da questão na aplicação é em ***py***.")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Arranha-céu"
            dados.rota_questao = "arranha_ceu"
