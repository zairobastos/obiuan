...
with col1:
    ...
    with col22:
        st.header("Grand Prix da Nlogônia")

    st.markdown("[Grand Prix da Nlogônia](https://olimpiada.ic.unicamp.br/pratique/p2/2019/f3/prix/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Grand Prix da Nlogônia"
            dados.rota_questao = "grand_prix_da_nlogonia"
