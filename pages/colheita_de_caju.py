...
with col1:
    ...
    with col22:
        st.header("Colheita de Caju")

    st.markdown("[Colheita de Caju](https://olimpiada.ic.unicamp.br/pratique/p2/2006/f1/caju/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Colheita de Caju"
            dados.rota_questao = "colheita_de_caju"
