...
with col1:
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Frete da Família Silva"
            dados.rota_questao = "frete_da_familia_silva"
