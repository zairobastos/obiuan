...
with col1:
    ...
    with col22:
        st.header("Fissura Perigosa")

    st.markdown("[Fissura Perigosa](https://olimpiada.ic.unicamp.br/pratique/p2/2020/f1/fissura/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Fissura Perigosa"
            dados.rota_questao = "fissura_perigosa"
