...
with col1:
    ...
    with col22:
        st.header("Cubo e quadrado")

    st.text("O número 729 tem uma particularidade interessante: é ao mesmo tempo o cubo e o quadrado de um número inteiro ( 729 = 272 e 729 = 93). Outro número com essa particularidade é 4096 (4096 = 642 e 4096 = 163). Sua tarefa é, dados dois números inteiros A e B, determinar quantos números no intervalo entre A e B são ao mesmo tempo cubo e quadrado de um número inteiro.")
    
    st.subheader("Entrada")
    st.text("A primeira da entrada contém um inteiro A, o limite inferior do intervalo de interesse, a segunda linha contém um inteiro B, o limite superior do intervalo de interesse (A e B fazem parte do intervalo de interesse).")

    st.subheader("Saída")
    st.text("Seu programa deve produzir uma única linha na saída, contendo um único inteiro, a quantidade de números que são ao mesmo tempo cubo e quadrado de um número inteiro, para todos os números do intervalo de interesse.")

    st.subheader("Restrições")
    st.markdown("&emsp; • 1 ≤ A < B ≤ 100 000 000")

    st.subheader("Informações sobre a pontuação")
    st.markdown("&emsp; • Para um conjunto de casos de testes valendo 30 pontos, B ≤ 100 000.")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Cubo e Quadrado"
            dados.rota_questao = "cubo_e_quadrado"
