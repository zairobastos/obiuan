...
with col1:
    ...
    with col22:
        st.header("Língua do P")

    st.markdown("[Língua do P](https://olimpiada.ic.unicamp.br/pratique/p2/2014/f1/lingua/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Lingua do P"
            dados.rota_questao = "lingua_do_p"
