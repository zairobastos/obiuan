...
with col1:
    ...
    with col22:
        st.header("Quebra-cabeça")

    st.markdown("[Quebra-cabeça](https://olimpiada.ic.unicamp.br/pratique/p2/2015/f1/quebra/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Quebra-cabeça"
            dados.rota_questao = "quebra_cabeca"
