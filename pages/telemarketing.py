...
with col1:
    ...
    with col22:
        st.header("Telemarketing")

    st.markdown("[Telemarketing](https://olimpiada.ic.unicamp.br/pratique/p2/2007/f2/tele/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Telemarketing"
            dados.rota_questao = "telemarketing"
