...
with col1:
    ...
    with col22:
        st.header("Subsequências")

    st.markdown("[Subsequências](https://olimpiada.ic.unicamp.br/pratique/p2/2006/f2/subsequencias/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Subsequências"
            dados.rota_questao = "subsequencias"
