...
with col1:
    ...
    with col22:
        st.header("Telescópio")

    st.markdown("[Telescópio](https://olimpiada.ic.unicamp.br/pratique/p2/2010/f2/telescopio/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Telescópio"
            dados.rota_questao = "telescopio"
