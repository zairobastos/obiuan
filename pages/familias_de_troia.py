...
with col1:
    ...
    with col22:
        st.header("Famílias de Troia")

    st.markdown("[Famílias de Troia](https://olimpiada.ic.unicamp.br/pratique/p2/2013/f2/troia/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Famílias de Troia"
            dados.rota_questao = "familias_de_troia"
