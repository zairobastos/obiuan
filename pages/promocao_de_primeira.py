...
with col1:
    ...
    with col22:
        st.header("Promoção de Primeira")

    st.markdown("[Promoção de Primeira](https://olimpiada.ic.unicamp.br/pratique/p2/2020/f1/promocao/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Promoção de Primeira"
            dados.rota_questao = "promocao_de_primeira"
