...
with col1:
    ...
    with col22:
        st.header("Botas Trocadas")

    st.markdown("[Botas Trocadas](https://olimpiada.ic.unicamp.br/pratique/p2/2017/f1/botas/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Botas Trocadas"
            dados.rota_questao = "botas_trocadas"
