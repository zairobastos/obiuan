...
with col1:
    ...
    with col22:
        st.header("Frequência na aula")

    st.markdown("[Frequência na aula](https://olimpiada.ic.unicamp.br/pratique/p2/2012/f1/frequencia/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Frequência na aula"
            dados.rota_questao = "frequencia_na_aula"
