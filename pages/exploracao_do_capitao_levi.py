...
with col1:
    ...
    with col22:
        st.header("Exploração do Capitão Levi")

    st.markdown("[Exploração do Capitão Levi](https://olimpiada.ic.unicamp.br/pratique/p2/2019/f3/exploracao/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Exploração do Capitão Levi"
            dados.rota_questao = "exploracao_do_capitao_levi"
