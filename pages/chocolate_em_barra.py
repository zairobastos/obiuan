...
with col1:
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Chocolate em Barra"
            dados.rota_questao = "chocolate_em_barra"
