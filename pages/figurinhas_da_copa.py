...
with col1:
    ...
    with col22:
        st.header("Figurinhas da copa")

    st.markdown("[Figurinhas da copa](https://olimpiada.ic.unicamp.br/pratique/p2/2018/f1/figurinhas/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Figurinhas da copa"
            dados.rota_questao = "figurinhas_da_copa"
