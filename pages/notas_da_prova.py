...
with col1:
    ...
    with col22:
        st.header("Notas da Prova")

    st.markdown("[Notas da Prova](https://olimpiada.ic.unicamp.br/pratique/p2/2009/f1/nota/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Notas da Prova"
            dados.rota_questao = "notas_da_prova"
