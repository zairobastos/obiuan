...
with col1:
    ...
    st.subheader("Saída")
    st.text("Seu programa deve imprimir, na saída padrão, uma única linha, contendo a maior quantidade de cebolas que Rodrigo pode comer a mais do que azeitonas.")
