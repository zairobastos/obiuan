...
with col1:
    ...
    with col22:
        st.header("Falha de segurança")

    st.markdown("[Falha de segurança](https://olimpiada.ic.unicamp.br/pratique/p2/2021/f3/falha/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Falha de Segurança"
            dados.rota_questao = "falha_de_seguranca"
