...
with col1:
    ...
    st.markdown("[Catálogo de Músicas](https://olimpiada.ic.unicamp.br/pratique/p2/2013/f1/catalogo/)")
    ...
    resposta = st.text_area("", 
                            ...
                            height=150)
    col13, col23, col33 = st.columns([4, 0.3, 0.21])
    # CSS com classes diferentes
    
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            dados.resposta = resposta
            dados.nome_questao = "Catálogo de Músicas"
            dados.rota_questao = "catalogo_de_musicas"
