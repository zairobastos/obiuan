...
with col1:
    ...
    with col22:
        st.header("Trem da mina")

    st.markdown("[Trem da mina](https://olimpiada.ic.unicamp.br/pratique/p2/2020/f3/trem/)")
    ...
    with col23:
        if st.button("Pedir dicas", key="dicas"):
            ...
            dados.nome_questao = "Trem da mina"
            dados.rota_questao = "trem_da_mina"
